...
class MovieNowPlayingFragment :
    ...
    private fun initBinding() {
        binding.apply {
            appbar.textTitle.text = getString(R.string.now_playing_movie)
    ...
    private fun subscribeUi() {
        observe(viewModel.nowPlayingMovie("nowplaying") ?: return) {
            binding.apply {
                when (it) {
    ...
    private fun navigateToDetail(movie: Movie) {
        findNavController().navigate(
            MovieNowPlayingFragmentDirections.actionMovieNowPlayingFragmentToDetailFragment(movie)
        )
    }

    private fun navigateToSetting() {
        findNavController().navigate(MovieNowPlayingFragmentDirections.actionMovieNowPlayingFragmentToSettingFragment())
    }
