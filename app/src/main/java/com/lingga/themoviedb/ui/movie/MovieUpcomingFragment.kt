...
class MovieUpcomingFragment :
    ...
    private fun initBinding() {
        binding.apply {
            appbar.textTitle.text = getString(R.string.upcoming_movie)
    ...
    private fun subscribeUi() {
        observe(viewModel.upComingMovie("upcoming") ?: return) {
            binding.apply {
                when (it) {
    ...
    private fun navigateToDetail(movie: Movie) {
        findNavController().navigate(
            MovieUpcomingFragmentDirections.actionMovieUpcomingFragmentToDetailFragment(movie)
        )
    }

    private fun navigateToSetting() {
        findNavController().navigate(MovieUpcomingFragmentDirections.actionMovieUpcomingFragmentToSettingFragment())
    }
